 ...
 */
public class RecordRechargeItemAdapter extends RecyclerView.Adapter<RecordRechargeItemAdapter.ViewHolder> {
    private Context context;
    private List<Recharge> mRechargeRecordList;


    public RecordRechargeItemAdapter(Context context, List<Recharge> recharges) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Recharge recharge = mRechargeRecordList.get(position);
