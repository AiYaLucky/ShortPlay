 ...
 */
public class RecordGetRechargeItemAdapter extends RecyclerView.Adapter<RecordGetRechargeItemAdapter.ViewHolder> {
    private Context context;
    private List<GetRecharge> mRechargeRecordList;


    public RecordGetRechargeItemAdapter(Context context, List<GetRecharge> recharges) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recharge_get_record, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        GetRecharge recharge = mRechargeRecordList.get(position);
